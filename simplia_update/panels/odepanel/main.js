 ...
 * @constructor
 */
function ODEPanel(Y, properties) {
    //Calling base constructor
    BasicPanel.call(this, Y);

    //Default title
    this.panelTitle = "Oxygen Development Environment";
...
ODEPanel.prototype = Object.create(BasicPanel.prototype);

/**
 * Main initialization function that also fetches the Mogopak URL data
 * @param {Function} cb - Callback function
 */
ODEPanel.prototype.init = function(cb) {
    var that = this;
