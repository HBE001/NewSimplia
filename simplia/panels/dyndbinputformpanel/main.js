 ...
 * @param callback
 */
DynDBInputFormPanel.prototype.getTableData = function(callback) {
    var that = this;

    var tableData = [];

    tableData.push(this.addTableDataRow({type: 'text', value: "Table Name"}, {type: "text", value: this.tableName}, "tableName"));
