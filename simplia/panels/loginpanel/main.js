...
LoginPanel.prototype.getTableData = function(callback) {
    ...
    tableData.push(this.addTableDataRow("Login", {type: "button", name: "Login", callback: function(){ that._login();}}));
    tableData.push(this.addTableDataRow("Reset Password", {type: "button", name: "Reset Password", callback: function(){ that._resetPassword();}}));
    ...
    $.ajax({
        ...
        success: function(data) {
            if(typeof data.error !== "undefined") {
                ...
                that._setStatus('Login successful!');
            }
        }
    })
