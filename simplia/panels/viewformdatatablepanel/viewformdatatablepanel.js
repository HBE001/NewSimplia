 ...
 * @constructor
 */
function ViewFormDatatablePanel(Y, properties) {
...
ViewFormDatatablePanel.prototype = Object.create(BasicDatabaseFormDatatablePanel.prototype);

/**
 * The initialization function that simply calls the base class's init function
 * @param cb
 */
ViewFormDatatablePanel.prototype.init = function(cb) {
    BasicDatabaseFormDatatablePanel.prototype.init.call(this, cb || undefined);

    //this._addWhiteBoardPanel();
};

/* ------------------------------------------------------------- */
ViewFormDatatablePanel.prototype._addWhiteBoardPanel = function() {
    var that = this;
