 ...
 * @constructor
 */
function OxygenCatalogPanel(Y, properties) {
    //Calling base constructor
    BasicPanel.call(this, Y);

    //Default title
    this.panelTitle = "Oxygen Catalog Panel";
...
OxygenCatalogPanel.prototype = Object.create(BasicPanel.prototype);

/**
 * Main initialization function that also fetches the Mogopak URL data
 * @param {Function} cb - Callback function
 */
OxygenCatalogPanel.prototype.init = function(cb) {
    var that = this;
