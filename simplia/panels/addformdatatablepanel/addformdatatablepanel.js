 ...
 * @constructor
 */
function AddFormDatatablePanel(Y, properties) {
...
AddFormDatatablePanel.prototype = Object.create(BasicDatabaseFormDatatablePanel.prototype);

/**
 * Main init function
 * @param cb
 */
AddFormDatatablePanel.prototype.init = function(cb) {
    var that = this;
 ...
 */
AddFormDatatablePanel.prototype.setupRightMenu = function() {
 ...
 */
AddFormDatatablePanel.prototype.selectInitialRows = function() {
    var recordIndices = [];
 ...
 */
AddFormDatatablePanel.prototype.setupLocalEventHandlers = function() {
