 ...
 * @constructor
 */
function DynamoDBEditFormDatatablePanel(Y, properties) {
...
DynamoDBEditFormDatatablePanel.prototype = Object.create(DynamoDBBasicDatabaseFormDatatablePanel.prototype);

/**
 * Main init function that also selects the non-primary key field rows
 * @param cb
 */
DynamoDBEditFormDatatablePanel.prototype.init = function(cb) {
    var that = this;
 ...
 */
DynamoDBEditFormDatatablePanel.prototype.setupRightMenu = function() {
 ...
 */
DynamoDBEditFormDatatablePanel.prototype.selectInitialRows = function() {
    var recordIndices = [];
