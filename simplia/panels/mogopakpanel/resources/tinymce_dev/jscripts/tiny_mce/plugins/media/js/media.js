(function() {
	...
	window.Media = {
		init : function() {
            ...
            var html = '<a id="srcbrowser_link" href="javascript:tinyMCE.tinyMCEPopup = tinyMCEPopup;tinyMCE.mogopakPanel.openFileBrowserDialog(\'media\');" onmousedown="return false;" class="browse">';
            html += '<span id="srcbrowser" title="' + tinyMCEPopup.getLang('browse') + '">&nbsp;</span></a>';
            get('filebrowsercontainer').innerHTML  = html;
			...
			tinyMCE.tinyMCEPopup = tinyMCEPopup;
		},
        ...
        setPath : function(path) {
            ...
            if(document.activeElement && document.activeElement.id == "src") {
                get('src').value = path;
                Media.formToData();
                return true;
            }
