<?php
	// General
	$moxieManagerConfig['general.license'] = 'UD4S-HFLT-QFGC-CLZE-CWQW-3MIL-2HHK-FETW';
	...
	//$moxieManagerConfig['filesystem.rootpath'] = '../../../../../projectsimgs';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,pdf,mp4,webm,ogg,oga,wav,mp3,m4a,aac,webm,swf,fla,flv,mov,asf,asx,avi,wma,wax,ra,ram,rm,rmm';
	...
	$moxieManagerConfig['upload.chunk_size'] = '15mb';
	...
	$moxieManagerConfig['view.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,pdf,mp4,webm,ogg,oga,wav,mp3,m4a,aac,webm,swf,fla,flv,mov,asf,asx,avi,wma,wax,ra,ram,rm,rmm';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "gopi@lotusmanagement.com", "password" => "LotusMoxie", "groups" => array("administrator"), "username" => "radu", "password" => "1234", "groups" => array("administrator"))
	);
