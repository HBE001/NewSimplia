...
//Mogopak - edit
        var h = '<a id="srcbrowser_link" href="javascript:tinyMCE.tinyMCEPopup = tinyMCEPopup;tinyMCE.mogopakPanel.openFileBrowserDialog(\'backgroundimage\');" onmousedown="return false;" class="browse">';
        h += '<span id="srcbrowser" title="' + tinyMCEPopup.getLang('browse') + '">&nbsp;</span></a>';
       	document.getElementById("background_image_browser").innerHTML  = h;
...
var setBackgroundPath = function(path) {
    var f = document.forms[0];
    //console.log('form-src:', f.src);
    //f.src.value = path;
    console.log(document.activeElement);

    if(document.activeElement && document.activeElement.id == "text_font") {
        mcTabs.displayTab('background_tab','background_panel');
        f.background_image.value = path;
        return true;
    }
    return false;
