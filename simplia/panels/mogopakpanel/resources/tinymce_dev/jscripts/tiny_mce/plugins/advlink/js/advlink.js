...
function init() {
    ...
    html = '<a id="hrefbrowser_link" href="javascript:tinyMCE.tinyMCEPopup = tinyMCEPopup;tinyMCE.mogopakPanel.openFileBrowserDialog(\'link\');" onmousedown="return false;" class="browse">';
    html += '<span id="hrefbrowser" title="' + tinyMCEPopup.getLang('browse') + '">&nbsp;</span></a>';
    document.getElementById('hrefbrowsercontainer').innerHTML = html;
...
var setLinkFormValue = function(path) {
    //console.log('active-element:' + document.activeElement.id);
    //console.log('href:' + document.forms[0].href);
    if(document.activeElement && (document.activeElement.id == "href")) {
        setFormValue('href', path);
        //console.log('returning true');
        selectByValue(document.forms[0],'linklisthref',path);
        return true;
    }
    return false;
};
