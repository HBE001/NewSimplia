...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		Editor : function(id, settings) {
            ...
            self.baseURI = ((typeof settings.base_url !== "undefined")? new tinymce.util.URI(settings.base_url) : tinymce.baseURI);
            tinymce.baseURI = self.baseURI;
            tinymce.baseURL = settings.base_url || tinymce.baseURL;
