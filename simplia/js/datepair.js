...
Datepair.prototype = {
    ...
    getStartTime: function () {
        ...
        return (((this.settings.parseTime(this.startTimeInput).getTime() / 1000) - timestamp ) + this.settings.parseDate(this.startDateInput).getTime() / 1000);
    },
    ...
    getEndTime: function () {
        ...
        return (((this.settings.parseTime(this.endTimeInput).getTime() / 1000) - timestamp) + this.settings.parseDate(this.endDateInput).getTime() / 1000);
    },
