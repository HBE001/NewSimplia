(function ($) {
    $.fn.searchit = function (options) {
        return this.each(function () {
            ...
            if (opts.textFields == null || opts.textFields.length == 0) {
                $t.before("<input type='textbox' class='__searchit" + $counter + "'><br>");
            ...
            if (opts.dropDown) {
                ...
                // not wrapping many times
                if ($(".__searchitWrapper0").length == 0) {
                    $t.wrap("<div class='__searchitWrapper" + $counter + "' />");
                }
