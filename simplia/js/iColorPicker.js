...
function iColorShow(colorValue, _changePenColor) {
    // add position in function variable if we need to customize it

    //var iColorWidth = jQuery("#iColorPicker").width();
    //jQuery("#iColorPicker").css({
    //    'top': position.top + "px",
    //    'left': (position.left - iColorWidth) + "px",
    //    'position': 'absolute'
    //}).fadeIn("fast");
    ...
    //jQuery('#colorPreview span').text(colorValue);
    jQuery('#colorPreview').css('background', colorValue);
    jQuery('#colorPreview span').css('background', colorValue);
    jQuery('#color').val(colorValue);
        ...
        for (j = 0; j < tblChilds.length; j++) {
            ...
            for (k = 0; k < tblCells.length; k++) {
                jQuery(tblChilds[j].childNodes[k]).unbind().mouseover(function (a) {
                    ...
                    console.log("Selected Color = " + aaa);
                    jQuery('#colorPreview span').css('background', aaa);
...
this.iColorPicker = function () {
    ...
    //jQuery("input.iColorPicker").after('<a href="javascript:void(null)" id="icp_' + jQuery("input.iColorPicker").attr('id') +
    //    '" onclick="iColorShow(\'' + jQuery("input.iColorPicker").attr('id'), jQuery('icp_' +
    //    jQuery("input.iColorPicker").attr('id')).position() + '\')"> Color </a>')
};
