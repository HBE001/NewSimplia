...
util.inherits(Authentication, BasicServerComponent);

Authentication.prototype.init = function(mCallback) {
    var that = this;
    async.waterfall([
        function(callback) {
...
Authentication.prototype.handleRoute = function (req, res, next) {
    var that = this;
