...
function AnonymousThreadType(params, callback) {
    BasicType.call(this, params, callback);
}

//Inheriting from the base object
util.inherits(AnonymousThreadType, BasicType);

AnonymousThreadType.prototype.init = function(callback) {
    var that = this;
...
AnonymousThreadType.prototype.handleRoute = function(req, res, next) {
    var that = this;
...
module.exports = AnonymousThreadType;