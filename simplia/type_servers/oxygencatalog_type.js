...
function OxygenCatalogType(params, callback) {
    BasicType.call(this, params, callback);
}

//Inheriting from the base object
util.inherits(OxygenCatalogType, BasicType);

OxygenCatalogType.prototype.init = function(callback) {
    var that = this;
...
OxygenCatalogType.prototype.handleRoute = function(req, res, next) {
    var that = this;
...
OxygenCatalogType.prototype.getClientTipData = function(clientData, mCallback) {
    var that = this;
    async.waterfall([
        function(callback){
...
module.exports = OxygenCatalogType;