...
function HomeThreadType(params, callback) {
    BasicType.call(this, params, callback);
}

//Inheriting from the base object
util.inherits(HomeThreadType, BasicType);

HomeThreadType.prototype.init = function(callback) {
    var that = this;
...
HomeThreadType.prototype.handleRoute = function(req, res, next) {
    var that = this;
